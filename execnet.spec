...
Source0  : https://files.pythonhosted.org/packages/99/f6/1963d06df2a3ae483c5dc6ed292b472f8eb1764b0b6415eafa894d938e7c/execnet-1.8.0.tar.gz
...
%prep
%setup -q -n execnet-1.8.0
cd %{_builddir}/execnet-1.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611763572
...
cp %{_builddir}/execnet-1.8.0/LICENSE %{buildroot}/usr/share/package-licenses/execnet/82dbfd684f7c04da81d4faa852c6317142daa3e7
